...
if (!existingLicense) {
  ...
  `).run('DWIRAB-DEMO0001', 'Pengguna Demo', 'demo@dwiarsitek.com', '081234567890', 'Lisensi contoh untuk testing');
  console.log('✅ Lisensi demo dibuat -> kode: DWIRAB-DEMO0001 (berlaku 365 hari)');
} else {
  console.log('ℹ️  Lisensi demo sudah ada, dilewati.');
}

// ============ 3. SEED PROVINSI DASAR (contoh, bisa ditambah via admin) ============
const provinsiList = [
...
// ============ 4. SEED KATEGORI MATERIAL DASAR ============
const kategoriList = [
...
for (const k of kategoriList) insertKategori.run(k);
